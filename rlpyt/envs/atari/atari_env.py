...
W, H = (80, 80)  # Crop two rows, then downsample by 2x (fast, clean image).
...
class AtariEnv(Env):
    ...
    def _update_obs(self):
        ...
        # img = cv2.resize(self._max_frame[34:194], (W, H), cv2.INTER_NEAREST)
        img = self._max_frame[34:194]
        img = img[::2, ::2, 0]
        # Erase left and right color for breakout
        img[img == 127] = 142
        img[img == 110] = 142
