...
class Distribution:
    ...
    def perplexity(self, dist_info, product=False):
        return torch.exp(self.entropy(dist_info, product=product))

    def mean_entropy(self, dist_info, valid=None, product=False):
        return valid_mean(self.entropy(dist_info, product=product), valid)
